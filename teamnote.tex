...
\documentclass[landscape, 10pt, a4paper, oneside,  twocolumn]{article}
...
\subsection {2-Commodity Flows (WIP)}
\added
...
\subsection{Offline Dynamic MST (WIP)}
\added

\subsection {Dominator Tree (WIP)}
\added
...
\end{minted}
\subsection{Suffix Automaton (WIP)}
\added
